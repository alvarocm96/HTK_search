...
## este código de a continuación serviría para pedirle al usuario que introdujera la ruta por pantalla. Sirve igual, 
# pero primero habría que acceder a ./solr-8.8.2 y luego extraer de ahí la ruta (click derecho -> propiedades -> copiar texto)
